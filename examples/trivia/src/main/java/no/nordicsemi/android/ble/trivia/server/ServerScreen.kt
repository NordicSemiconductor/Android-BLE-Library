package no.nordicsemi.android.ble.trivia.server
...
import no.nordicsemi.android.ble.trivia.client.view.LoadingView
import no.nordicsemi.android.ble.trivia.server.data.DownloadingQuestions
import no.nordicsemi.android.ble.trivia.server.data.Round
import no.nordicsemi.android.ble.trivia.server.data.WaitingForPlayers
import no.nordicsemi.android.ble.trivia.server.data.toViewState
...
import no.nordicsemi.android.ble.trivia.server.view.BottomNavigationView

...
class FlagBasedPacketSplitter : DataSplitter {
     ...
     * The methods first checks whether the whole message can fit into a single packet.
     * If so, it returns a new byte array containing the message with the FULL flag appended to the beginning.
     * If the message is longer, the function checks whether this is the first packet of the message.
     ...
     * the function returns null. If there are still bytes remaining, the function checks whether this
